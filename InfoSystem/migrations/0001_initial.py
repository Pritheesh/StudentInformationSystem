# -*- coding: utf-8 -*-
# Generated by Django 1.10.4 on 2017-03-12 13:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('examinfo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='examinfo', to='InfoSystem.ExamInfo')),
            ],
        ),
        migrations.CreateModel(
            name='Student',
        ...
        migrations.AddField(
            model_name='result',
            name='student',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='stud_results', to='InfoSystem.Student'),
        ),
        migrations.AddField(
            model_name='result',
            name='subject',
